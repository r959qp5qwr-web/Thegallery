/* One 24px line icon family, injected once as an SVG sprite (ux/INTERFACE_FOUNDATION.md §6). Use: <svg class="icon"><use href="#i-search"/></svg> */
(function () {
  if (/[?&]full=1/.test(location.search)) document.documentElement.classList.add('fullpage');
  ...
  '</svg>';
  document.addEventListener('DOMContentLoaded', function () { var d = document.createElement('div'); d.innerHTML = s; document.body.insertBefore(d.firstChild, document.body.firstChild); });
})();
